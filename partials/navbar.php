...
.navbar-logo { display: flex; align-items: center; gap: 10px; font-weight: bold; font-size: 18px; color: #1b2b4b; }
.navbar-logo img { height: 36px; }
.navbar-menu { display: flex; gap: 25px; align-items: center; }
.navbar-menu a { text-decoration: none; color: #1b2b4b; font-weight: 500; }
.navbar-profile {
...
@media (max-width: 768px) {
    ...
    .navbar-menu {
        position: absolute; top: 65px; left: 0; right: 0; background: #dbe5f1;
        flex-direction: column; gap: 15px; padding: 15px; display: none;
    }
...
<nav class="navbar">
    <div class="navbar-container">
        <div class="navbar-logo">
            <img src="../assets/logo-tranzio.png" alt="Tranzio">
        </div>
        ...
        <div class="navbar-menu" id="navbarMenu">
            ...
            <?php if ($userLogin): ?>
                ...
                <a href="akun/index.php" class="navbar-profile">
                    <?php if ($profileImg): ?>
